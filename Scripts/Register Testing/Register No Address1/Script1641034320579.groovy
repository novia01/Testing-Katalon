...
WebUI.setText(findTestObject('Object Repository/Register_Demo/Page_JPetStore Demo/input_Phone_account.phone'), '090808')

WebUI.setText(findTestObject('Object Repository/Register_Demo/Page_JPetStore Demo/input_Address 1_account.address1'), '')
