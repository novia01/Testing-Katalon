...
WebUI.setText(findTestObject('Object Repository/Register_Demo/Page_JPetStore Demo/input_Email_account.email'), '')

WebUI.setText(findTestObject('Object Repository/Register_Demo/Page_JPetStore Demo/input_Phone_account.phone'), '09090')
