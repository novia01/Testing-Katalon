...
WebUI.setText(findTestObject('Object Repository/Page_JPetStore Demo/input_User ID_username'), 'lumintu')

WebUI.setText(findTestObject('Object Repository/Page_JPetStore Demo/input_New password_password'), 'lumintu')

WebUI.setText(findTestObject('Object Repository/Page_JPetStore Demo/input_Repeat password_repeatedPassword'), 'lumintu')

WebUI.setText(findTestObject('Object Repository/Page_JPetStore Demo/input_First name_account.firstName'), 'lumintu')

WebUI.setText(findTestObject('Object Repository/Page_JPetStore Demo/input_Last name_account.lastName'), '')

WebUI.setText(findTestObject('Object Repository/Page_JPetStore Demo/input_Email_account.email'), 'lumintu@gmail.com')

WebUI.setText(findTestObject('Page_JPetStore Demo/input_Phone_account.phone'), '0858888')

WebUI.setText(findTestObject('Object Repository/Page_JPetStore Demo/input_Address 1_account.address1'), 'lumintu')
