...
WebUI.setText(findTestObject('Object Repository/Register_Demo/Page_JPetStore Demo/input_Phone_account.phone'), '08080')
...
WebUI.setText(findTestObject('Object Repository/Register_Demo/Page_JPetStore Demo/input_State_account.state'), '')
